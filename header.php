    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="about.html" class="nav-item nav-link">Precios</a>
                <a href="service.html" class="nav-item nav-link">Soporte</a>
                <a href="roadmap.html" class="nav-item nav-link">Aprende</a>
                ...
                <a href="contact.html" class="nav-item nav-link">Inglés</a>
                <a href="roadmap.html" class="nav-item nav-link">Aprende</a>
            </div>
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                <a href="roadmap.html" class="nav-item nav-link pl-10">Iniciar Sesión</a>
                <a href="roadmap.html" class="nav-item nav-link">Registro</a>
            </div>
